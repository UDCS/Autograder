...
type App interface {
	...
	GetStudentAssignmentGrades(jwksToken string, classroomId uuid.UUID, assignmentId uuid.UUID, studentId uuid.UUID) (models.StudentAssignmentGradesResult, error)
